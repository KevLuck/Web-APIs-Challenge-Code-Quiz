...
var questionsObject = {
    correct: {
        ...
        1: "The condition statement if/else is enclosed with:",
        2: "Arrays in JavaScript can be used to store________",
        3: "A very useful tool used during development and debugging for printing content " +
                "to the debugger is:",
        4: "Strings values must be enclosed within___________when being assigned to variab" +
                "les"
    }
};
...
viewHighScoresBtnEl.addEventListener("click", function () {
    ...
    for (var i = 0; i < localStorage.length; i++) {
        ...
        if (substringTest == "quiz") {
            ...
            highScores += "User " + userName.substring(4) + " high score is: " +
                    checkUserValue[1] + "\n";
        }
    }
...
submitScoreEl.addEventListener("click", function () {
    ...
    for (var i = 0; i < localStorage.length; i++) {
        ...
        if (checkUser == null) {
            ...
            window.alert(
                "Your score of " + highScore + " has been submitted!"
            )
            break;
        ...
        if (quizUserDetails == checkUserValue[0] && highScore == checkUserValue[1]) {
            ...
            localStorage.setItem(quizUserDetails, value);
            window.alert(
                highScore + " is the latest entry for user initial " + enterInitialsTextArea.value +
            ...
            localStorage.setItem(quizUserDetails, value);
            window.alert(
                "New high score of " + highScore + " has been submitted!.\nYour previous score " +
                "was " + checkUserValue[1]
            )
            break;
        } else if (quizUserDetails == checkUserValue[0] && highScore < checkUserValue[1]) {
            ...
            localStorage.setItem(quizUserDetails, value);
            window.alert(
                "Your previous code of " + checkUserValue[1] + " was higher. Entry will not be " +
                "added."
            );
            break;
    ...
    var timeInterval = setInterval(function () {
        ...
        if (timeLeft >= 1 && finalAnswerCheck !== 1) {
            ...
            answer1BtnEl.addEventListener("click", function () {
                ...
                if (questionDisplay.textContent === "The condition statement if/else is enclosed with the following:" && answer1BtnEl.textContent === "Parenthesis") {
                    console.log("Correct");
